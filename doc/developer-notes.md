...
Run with the -testnet option to run with "play dedcoins" on the test network, if you
...
- DedcoinMiner : Generates dedcoins (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:dedcoin/dedcoin.git
