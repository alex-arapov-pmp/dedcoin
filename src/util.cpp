...
const char * const BITCOIN_CONF_FILENAME = "dedcoin.conf";
const char * const BITCOIN_PID_FILENAME = "dedcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Dedcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Dedcoin";
#else
    // Unix
    return pathRet / ".dedcoin";
#endif
#endif
}
