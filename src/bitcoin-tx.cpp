...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dedcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dedcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dedcoin transaction") + "\n" +
              "  dedcoin-tx [options] -create [commands]   " + _("Create hex-encoded dedcoin transaction") + "\n" +
              "\n";
