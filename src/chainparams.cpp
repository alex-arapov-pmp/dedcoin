...
// Copyright (c) 2024-2026 The Dedcoin Core developers
...
{
    const char* pszTimestamp = "DancingDed, No Ads, No Brands, No Profits, August 17, 2024";
...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Dedcoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Dedcoin values
