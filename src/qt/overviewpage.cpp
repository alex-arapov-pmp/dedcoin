...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Dedcoin Core repository on GitHub"),
        tr("Services that claim to double your dedcoins are always ponzi schemes")
    };
