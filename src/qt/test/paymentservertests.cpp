...
// Copyright (c) 2020-2023 The Dedcoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Dedcoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Dedcoin (as there is no actual maximum coins)
