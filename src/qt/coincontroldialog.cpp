...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    if (nQuantity > 0)
    {
        ...
        if (fWitness)
        {
            ...
            // usually, the result will be an overestimate within a couple of farthings so that the confirmation dialog ends up displaying a slightly smaller fee.
    ...
    // how many farthings the estimated fee can vary per byte we guess wrong
    double dFeeVary;
