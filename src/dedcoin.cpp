...
// Dedcoin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateDedcoinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetDedcoinBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
