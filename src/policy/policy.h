...
/** Recommended transaction fee by Dedcoin Core developers
  *
 ...
 *
 *  Dedcoin:    Increment mempool limits and accept RBF in steps of 0.0001 DEDC
...
/**
 * Dedcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Dedcoin: Default hard dust limit that is evaluated when considering whether
