...
# TestNode: A peer we use to send messages to dedcoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes dedcoind to (reasonably!) disconnect us, so do this last.
    ...
    def test_compactblock_construction(self, node, test_node, version, use_witness_address):
        ...
        if use_witness_address:
            ...
            node.sendtoaddress(address, farthing_round(value_to_send-Decimal(0.1)))
            node.generate(1)
    ...
    # Test that dedcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for dedcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # dedcoind will not send blocktxn responses for blocks whose height is
