...
class FullBlockTest(ComparisonTestFramework):
    ...
    def next_block(self, number, spend=None, additional_coinbase_value=0, script=CScript([OP_TRUE]), solve=True):
        ...
        if spend == None:
            ...
            coinbase.vout[0].nValue += spend.tx.vout[spend.n].nValue - 1 # all but one farthing to fees
            coinbase.rehash()
            block = create_block(base_block_hash, coinbase, block_time)
            tx = create_transaction(spend.tx, spend.n, b"", 1, script)  # spend 1 farthing
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure dedcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure dedcoind isn't accepting b28
        ...
        # Create a transaction that spends one farthing to the p2sh_script, the rest to OP_TRUE
        ...
        # Until block is full, add tx's with 1 farthing to p2sh_script, the rest to OP_TRUE
        tx_new = None
        tx_last = tx
        ...
        #                                                                                    \-> b68 (20)
        #
        # b68 - coinbase with an extra 10 farthings,
        #       creates a tx that has 9 farthings from out[20] go to fees
        #       this fails because the coinbase is trying to claim 1 farthing too much in fees
        #
        # b69 - coinbase with extra 10 farthings, and a tx that gives a 10 farthing fee
        #       this succeeds
        #
        tip(65)
        ...
        #
        # dedcoin: Currently this causes a node disconnect, and I'm not even sure that's wrong.
